...
const buildCommand =
  process.env.TEST_INDEXING_MODE === "indexed"
    ? `PUBLIC_SITE_ORIGIN=https://verranlabs.com PUBLIC_SITE_INDEXING=enabled PUBLIC_TALLY_FORM_ID=test-form PUBLIC_BOOKING_URL=https://calendar.google.com/calendar/appointments/schedules/test-fit-call${analyticsEnvironmentFragment} npm run build`
